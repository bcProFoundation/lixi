...
export const { useCommentQuery, useLazyCommentQuery, useCommentsToCommentableIdQuery, useLazyCommentsToCommentableIdQuery, useCreateCommentMutation } = injectedRtkApi;
