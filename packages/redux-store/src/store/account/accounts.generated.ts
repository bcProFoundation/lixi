...
export const { useAccountQuery, useLazyAccountQuery, useGetAccountByAddressQuery, useLazyGetAccountByAddressQuery, useCreateAccountMutation, useImportAccountMutation, useUpdateAccountMutation } = injectedRtkApi;
