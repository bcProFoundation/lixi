...
const injectedRtkApi = api.injectEndpoints({
  ...
  endpoints: build => ({
    ...
    PinnedPostByPageId: build.query<PinnedPostByPageIdQuery, PinnedPostByPageIdQueryVariables>({
      query: variables => ({ document: PinnedPostByPageIdDocument, variables })
    }),
    PinnedPostByUserId: build.query<PinnedPostByUserIdQuery, PinnedPostByUserIdQueryVariables>({
      query: variables => ({ document: PinnedPostByUserIdDocument, variables })
    }),
