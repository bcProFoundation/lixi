...
export type PostBurnHistoryQuery = { __typename?: 'Query', postBurnHistory: { __typename?: 'BurnBasicConnection', totalCount: number, edges: Array<{ __typename?: 'BurnItemBasicEdge', cursor: string, node: { __typename?: 'BurnItem', id: string, txid: string, burnType: boolean, burnForType: Types.BurnForTypeItem, burnForId: string, burnedValue: number, createdAt?: any | null, updatedAt?: any | null, burnedBy: { __typename?: 'Account', id: number, name: string, avatar?: string | null, address: string } } }>, pageInfo: { __typename?: 'BasicPageInfo', endCursor: string, hasNextPage: boolean } } };
