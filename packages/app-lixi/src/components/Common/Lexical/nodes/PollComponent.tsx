...
const PollContainer = styled.div`
  ...
  .PollNode__optionInput {
    ...
    border: 0px;
    padding: 7px;
    color: var(--border-color-dark-base);
  ...
  .PollNode__optionCheckboxChecked {
    border: 1px solid var(--border-color-dark-base);
    background-color: var(--border-color-dark-base);
  }
...
function PollOptionComponent({
  ...
  return (
    <div className="PollNode__optionContainer">
      <div className={`PollNode__optionCheckboxWrapper ${checked && 'PollNode__optionCheckboxChecked'}`}>
        <input
          ref={checkboxRef}
      ...
      <div className={`PollNode__container ${isFocused ? 'focused' : ''}`} ref={ref}>
        <div className="PollNode__inner">
          ...
          <div className="PollNode__footer">
            <Button type="primary" className="outline-btn" disabled={question.trim() === ''} onClick={addOption}>
