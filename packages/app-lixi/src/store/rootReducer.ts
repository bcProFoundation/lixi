...
import {
    AccountsState, CategoriesState, ClaimsState,
    CountriesState, LixiesState, LocalUserAccountsState,
    PageMessageSessionState, PageState, PostState,
    SettingsState, StatesState, WalletState,
    accountReducer, actionSheetReducer, burnReducer,
    categoryReducer, claimReducer, countryReducer,
    envelopeReducer, errorReducer, lixiReducer,
    loadingReducer, localUserAccountReducer,
    messageReducer, modalReducer, notificationReducer,
    pageReducer, postReducer, settingsReducer, stateReducer,
    toastReducer, tokenReducer, walletStateReducer, actionReducer
} from '@store/index';
