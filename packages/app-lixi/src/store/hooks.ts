...
export const useSliceDispatch = () => useDispatch<AppDispatch>();
export const useSliceSelector: TypedUseSelectorHook<RootState> = useSelector;
...
initializeLixiSlice(useSliceDispatch, useSliceSelector);
